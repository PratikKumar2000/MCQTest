...
public class GUI5 extends Frame implements ItemListener {
        Button b;
        String ans;
        String res;
        CheckboxGroup cg1;
        ...
        Checkbox cb3;
        Checkbox cb4;
        public GUI5(String s1, String s2, String s3, String s4, String s5,GUI4 g1){
            setTitle("JAVA Quiz");
        ...
        public void set(GUI1 g, GUI2 g1, GUI3 g2,GUI4 g3, GUI5 g4){
            b.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    setVisible(false);
                    new Final(g,g1,g2,g3,g4);
                }
            });
        }
